  ...
  <div class="max-h-screen -ml-4 md:-ml-6">
    <div class="relative z-40 md:hidden" role="dialog" aria-modal="true">
      <transition enter-active-class="transition-opacity ease-linear duration-300" enter-from-class="opacity-0"
        ...
        <div v-if="showMobileMenu" class="fixed inset-0 bg-gray-600 bg-opacity-75"></div>
      </transition>
      <transition enter-active-class="transition-transform duration-500" enter-from-class="-translate-x-full"
        ...
        <div v-if="showMobileMenu" class="fixed inset-0 z-40 flex mt-8">
    ...
    <div class="flex flex-1 flex-col md:pl-64">
      <div class="bg-white shadow sticky top-0 z-10  pl-1 pt-1 sm:pl-3 sm:pt-3 md:hidden">
        <button type="button"
                @click="toggleMobileMenu"
