...
<template>
  <div class="max-h-screen -ml-4 md:-ml-6 font-sans">
    ...
    <div aria-modal="true" class="relative md:hidden" role="dialog">
      ...
      >
        <div v-if="showMobileMenu" class="fixed inset-0 flex z-50">
          <div
            class="relative flex w-full max-w-xs flex-1 flex-col bg-indigo-700 py-5"
          >
    ...
    <div
      class="hidden md:mt-8 md:fixed md:inset-y-0 md:flex md:w-64 md:flex-col"
    >
    ...
    <div class="flex flex-1 flex-col md:pl-64 bg-slate-100 w-full">
      ...
      <div
        class="bg-white shadow sticky top-0 pl-1 pt-1 sm:pl-3 sm:pt-3 md:hidden"
      >
        <button
